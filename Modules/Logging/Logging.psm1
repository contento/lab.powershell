...
function Write-Log {
    ...
    param (
        ...
        [Parameter(Mandatory = $false, HelpMessage = "Encoding. Default UTF8")] 
    ...
    process {
        ...
        if ($UseTee) {
            $line | Tee-Object -Encoding $Encoding -FilePath $Path -Append
        }
        else {
            $line | Out-File -Encoding $Encoding -FilePath $Path -Append
        } 
    }
